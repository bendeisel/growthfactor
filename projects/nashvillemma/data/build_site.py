...
@media (max-width: 620px) {
  ...
  /* At 1440 the photo covers by width, so object-position X does nothing.
     At 390 it covers by height and crops 420px horizontally, which lands on
     the middle of the frame and cuts the fighter's head off. Pushed right to
     keep him. Desktop is unaffected by this for the reason above. */
  .bleedhero img { object-position: 80% 22% !important; }
